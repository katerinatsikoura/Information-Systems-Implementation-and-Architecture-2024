    ...
    <main>
        <div class="main_cont">
            <div class="form-container">
                ...
                <form class="form" action="XregisterController.jsp" method="post">
                    <div class="form-group">
                        <label for="first-name">Name</label>
                        <input type="text" class="inputtext" id="first-name" name="first-name" placeholder="your name" required>
                    </div>
                    <div class="form-group">
                        <label for="last-name">Lastname</label>
                        <input type="text" class="inputtext" id="last-name" name="last-name" placeholder="your lastname" required>
                    </div>
                    <div class="form-group">
