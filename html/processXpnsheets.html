            ...
            <div class="head_left">
                ...
                <div class="nav_bar">
                    <ul class="nav_l">
                        ...
                        <a href="processXpnsheets.html" id="current"><li>View Processed Expensheets</li></a>
                    </ul>
                </div>
            </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="id">10</td>
                                                <td>2024-10-31</td>
                                                <td class="approved" id="man_approved">
                                                    <img id="yes" class="active" src="../images/Approved_Icon.png" alt="Approved">
                                                    <img id="no" src="../images/Declined_Icon.png" alt="Rejected">
                                                </td>
                                                <td class="approved" id="acc_approved">
                                                    <img id="yes" src="../images/Approved_Icon.png" alt="Approved">
                                                    <img id="no" src="../images/Declined_Icon.png" alt="Rejected">
                                                </td>
                                                <td class="approved" id="f_approved">
                                                    <img id="yes" src="../images/Approved_Icon.png" alt="Approved">
                                                    <img id="no" src="../images/Declined_Icon.png" alt="Rejected">
                                                </td>
                                                <td class="details">
                                            ...
                                            <tr>
                                                ...
                                                <td class="approved" id="acc_approved">
                                                    <img id="yes" src="../images/Approved_Icon.png" alt="Approved">
                                                    <img id="no" class="active" src="../images/Declined_Icon.png" alt="Rejected">
                                                </td>
                                                <td class="approved" id="f_approved">
                                                    <img id="yes" src="../images/Approved_Icon.png" alt="Approved">
                                                    <img id="no" class="active" src="../images/Declined_Icon.png" alt="Rejected">
